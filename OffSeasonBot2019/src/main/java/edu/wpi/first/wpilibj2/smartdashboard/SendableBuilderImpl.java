    ...
    if (setter != null) {
      property.m_createListener = entry -> entry.addListener(event -> {
        if (event.value.isBoolean()) {
          edu.wpi.first.wpilibj2.smartdashboard.SmartDashboard.postListenerTask(() -> setter.accept(event.value.getBoolean()));
        }
    ...
    if (setter != null) {
      property.m_createListener = entry -> entry.addListener(event -> {
        if (event.value.isDouble()) {
          edu.wpi.first.wpilibj2.smartdashboard.SmartDashboard.postListenerTask(() -> setter.accept(event.value.getDouble()));
        }
      }, EntryListenerFlags.kImmediate | EntryListenerFlags.kNew | EntryListenerFlags.kUpdate);
    }
    m_properties.add(property);
    ...
    if (setter != null) {
      property.m_createListener = entry -> entry.addListener(event -> {
        if (event.value.isString()) {
          edu.wpi.first.wpilibj2.smartdashboard.SmartDashboard.postListenerTask(() -> setter.accept(event.value.getString()));
        }
      }, EntryListenerFlags.kImmediate | EntryListenerFlags.kNew | EntryListenerFlags.kUpdate);
    }
    m_properties.add(property);
    ...
    if (setter != null) {
      property.m_createListener = entry -> entry.addListener(event -> {
        if (event.value.isBooleanArray()) {
          edu.wpi.first.wpilibj2.smartdashboard.SmartDashboard.postListenerTask(() -> setter.accept(event.value.getBooleanArray()));
        }
      }, EntryListenerFlags.kImmediate | EntryListenerFlags.kNew | EntryListenerFlags.kUpdate);
    }
    m_properties.add(property);
    ...
    if (setter != null) {
      property.m_createListener = entry -> entry.addListener(event -> {
        if (event.value.isDoubleArray()) {
          edu.wpi.first.wpilibj2.smartdashboard.SmartDashboard.postListenerTask(() -> setter.accept(event.value.getDoubleArray()));
        }
      }, EntryListenerFlags.kImmediate | EntryListenerFlags.kNew | EntryListenerFlags.kUpdate);
    }
    m_properties.add(property);
    ...
    if (setter != null) {
      property.m_createListener = entry -> entry.addListener(event -> {
        if (event.value.isStringArray()) {
          edu.wpi.first.wpilibj2.smartdashboard.SmartDashboard.postListenerTask(() -> setter.accept(event.value.getStringArray()));
        }
      }, EntryListenerFlags.kImmediate | EntryListenerFlags.kNew | EntryListenerFlags.kUpdate);
    }
    m_properties.add(property);
    ...
    if (setter != null) {
      property.m_createListener = entry -> entry.addListener(event -> {
        if (event.value.isRaw()) {
          edu.wpi.first.wpilibj2.smartdashboard.SmartDashboard.postListenerTask(() -> setter.accept(event.value.getRaw()));
        }
      }, EntryListenerFlags.kImmediate | EntryListenerFlags.kNew | EntryListenerFlags.kUpdate);
    }
    m_properties.add(property);
