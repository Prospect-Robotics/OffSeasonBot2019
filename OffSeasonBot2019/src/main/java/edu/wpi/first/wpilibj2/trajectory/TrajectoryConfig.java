...
package edu.wpi.first.wpilibj2.trajectory;

import java.util.ArrayList;
import java.util.List;

import edu.wpi.first.wpilibj2.kinematics.DifferentialDriveKinematics;
import edu.wpi.first.wpilibj2.kinematics.MecanumDriveKinematics;
import edu.wpi.first.wpilibj2.kinematics.SwerveDriveKinematics;
import edu.wpi.first.wpilibj2.trajectory.constraint.DifferentialDriveKinematicsConstraint;
import edu.wpi.first.wpilibj2.trajectory.constraint.MecanumDriveKinematicsConstraint;
import edu.wpi.first.wpilibj2.trajectory.constraint.SwerveDriveKinematicsConstraint;
import edu.wpi.first.wpilibj2.trajectory.constraint.TrajectoryConstraint;
